...
def short_integration(integrationN, minA, maxA, minE, maxE, maxI, nParticles, startTime, shortTime, fileName):
    ...
    print("short integration {} took {}".format(integrationN, time.time() - start.time())
