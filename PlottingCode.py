...
def create_plots(dat, ST):
    ...
    fileDirectories = glob.glob("/data/galadriel/ahr/kboTest/Long_Integrations/{}*".format(dat))
    ...
    plotDestinPath = '/data/galadriel/ahr/kboTest/Plotting_files/'.format(dat)
    ...
    plt.show()
    plt.savefig('/data/galadriel/ahr/kboTest/Plotting_files/{}/ave_t={}.png'.format(dat, ST))
    plt.clf()
    ...
    plt.axvline(x=maxA, color = 'black', linestyle = '-')
    plt.show()
    plt.savefig('/data/galadriel/ahr/kboTest/Plotting_files/{}/avi_t={}.png'.format(dat, ST))
    plt.clf()   
